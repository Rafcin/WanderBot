...
"""autogenerated by genpy from image_recognition_msgs/AnnotateRequest.msg. Do not edit."""
import sys
...
class AnnotateRequest(genpy.Message):
  _md5sum = "8cc91912a5e6a23decc502ffc5dae050"
  _type = "image_recognition_msgs/AnnotateRequest"
...
bool do_rectify
"""
  __slots__ = ['image','annotations']
  _slot_types = ['sensor_msgs/Image','image_recognition_msgs/Annotation[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AnnotateRequest, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = image_recognition_msgs.msg.Annotation()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from image_recognition_msgs/AnnotateResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AnnotateResponse(genpy.Message):
  _md5sum = "d41d8cd98f00b204e9800998ecf8427e"
  _type = "image_recognition_msgs/AnnotateResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
"""
  __slots__ = []
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AnnotateResponse, self).__init__(*args, **kwds)
...
class Annotate(object):
  _type          = 'image_recognition_msgs/Annotate'
  _md5sum = '8cc91912a5e6a23decc502ffc5dae050'
  _request_class  = AnnotateRequest
  _response_class = AnnotateResponse
