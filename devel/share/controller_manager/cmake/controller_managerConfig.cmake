...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/nvidia/zuckbot_ws/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/nvidia/zuckbot_ws/devel)
  ...
  set(controller_manager_INSTALL_PREFIX /home/nvidia/zuckbot_ws/install)
...
if(NOT "/home/nvidia/zuckbot_ws/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/zuckbot_ws/src/ros_control/controller_manager/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/zuckbot_ws/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
    _list_append_unique(controller_manager_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "controller_manager;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
