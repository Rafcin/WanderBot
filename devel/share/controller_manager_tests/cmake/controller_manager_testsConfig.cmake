...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/nvidia/zuckbot_ws/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/nvidia/zuckbot_ws/devel)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/nvidia/zuckbot_ws/install)
...
if(NOT "/home/nvidia/zuckbot_ws/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/zuckbot_ws/src/ros_control/controller_manager_tests/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/zuckbot_ws/src/ros_control/controller_manager_tests/${idir}'.  ${_report}")
    endif()
