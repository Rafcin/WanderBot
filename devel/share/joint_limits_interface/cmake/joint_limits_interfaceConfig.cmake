...
if("TRUE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /home/nvidia/zuckbot_ws/src/ros_control/joint_limits_interface)
  set(joint_limits_interface_DEVEL_PREFIX /home/nvidia/zuckbot_ws/devel)
  ...
  set(joint_limits_interface_INSTALL_PREFIX /home/nvidia/zuckbot_ws/install)
...
if(NOT "/home/nvidia/zuckbot_ws/src/ros_control/joint_limits_interface/include;/usr/include " STREQUAL " ")
  set(joint_limits_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/zuckbot_ws/src/ros_control/joint_limits_interface/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/zuckbot_ws/src/ros_control/joint_limits_interface/${idir}'.  ${_report}")
    endif()
    _list_append_unique(joint_limits_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/aarch64-linux-gnu/liburdfdom_sensor.so;/usr/lib/aarch64-linux-gnu/liburdfdom_model_state.so;/usr/lib/aarch64-linux-gnu/liburdfdom_model.so;/usr/lib/aarch64-linux-gnu/liburdfdom_world.so;/usr/lib/aarch64-linux-gnu/libconsole_bridge.so")
