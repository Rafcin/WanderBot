...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/nvidia/zuckbot_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/nvidia/zuckbot_ws/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/nvidia/zuckbot_ws/install)
...
if(NOT "/home/nvidia/zuckbot_ws/src/geometry/eigen_conversions/include;/usr/local/include/eigen3;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/zuckbot_ws/src/geometry/eigen_conversions/include;/usr/local/include/eigen3;/usr/include/eigen3;/opt/ros/kinetic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/zuckbot_ws/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
