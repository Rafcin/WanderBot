...
if(NOT "include;/usr/local/include/eigen3;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/include/eigen3;/usr/include/eigen3;/opt/ros/kinetic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/zuckbot_ws/install/${idir}'.  ${_report}")
    endif()
