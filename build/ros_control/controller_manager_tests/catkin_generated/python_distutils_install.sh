...
echo_and_run cd "/home/nvidia/zuckbot_ws/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/zuckbot_ws/build/ros_control/controller_manager_tests" \
    install \
    $DESTDIR_ARG \
