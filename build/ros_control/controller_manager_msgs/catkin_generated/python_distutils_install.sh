...
echo_and_run cd "/home/nvidia/zuckbot_ws/src/ros_control/controller_manager_msgs"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/zuckbot_ws/build/ros_control/controller_manager_msgs" \
    install \
    $DESTDIR_ARG \
