...
echo_and_run cd "/home/nvidia/zuckbot_ws/src/image_recognition/tensorflow_ros_rqt"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/zuckbot_ws/build/image_recognition/tensorflow_ros_rqt" \
    install \
    $DESTDIR_ARG \
