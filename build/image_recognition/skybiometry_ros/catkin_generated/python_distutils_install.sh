...
echo_and_run cd "/home/nvidia/zuckbot_ws/src/image_recognition/skybiometry_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/zuckbot_ws/build/image_recognition/skybiometry_ros" \
    install \
    $DESTDIR_ARG \
