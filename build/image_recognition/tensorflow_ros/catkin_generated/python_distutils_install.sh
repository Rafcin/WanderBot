...
echo_and_run cd "/home/nvidia/zuckbot_ws/src/image_recognition/tensorflow_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/zuckbot_ws/build/image_recognition/tensorflow_ros" \
    install \
    $DESTDIR_ARG \
